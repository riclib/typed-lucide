// GENERATED by typed-lucide/generate from lucide 1.41.0 — do not edit

//! Every Lucide icon, its name and its body.
//!
//! Regenerate with `cargo run -p generate -- <lucide-tag>`.

/// Every icon in Lucide 1.41.0.
///
...
impl Icon {
    ...
    /// How many icons this crate carries: 1807.
    pub const COUNT: usize = 1807;
    ...
    /// The inner SVG elements, for your own `<svg>`.
    ///
    /// Lucide's markup with the outer `<svg>` element removed: the
    /// attributes in Lucide's order, the path data untouched.
    pub fn body(self) -> &'static str {
        BODIES[self as usize]
    }

    /// The icon with this exact kebab name, if Lucide has one.
    pub fn from_name(name: &str) -> Option<Icon> {
        NAMES.binary_search(&name).ok().map(|i| Self::ALL[i])
    }
}

/// The `<svg>` attributes every Lucide icon carries, in Lucide's order.
pub(crate) const SVG_ATTRS: &str = "xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2\" stroke-linecap=\"round\" stroke-linejoin=\"round\"";

static NAMES: [&str; 1807] = [
    "a-arrow-down",
    "a-arrow-up",
    "a-large-small",
    "accessibility",
...
static BODIES: [&str; 1807] = [
    ...
    "<path d=\"M12 5v14\"/><path d=\"m18.065 8.496-12.125 7\"/><path d=\"m5.94 8.504 12.125 7\"/>",
    ...
    "<path d=\"M16.4 13.7A6.5 6.5 0 1 0 6.28 6.6c-1.1 3.13-.78 3.9-3.18 6.08A3 3 0 0 0 5 18c4 0 8.4-1.8 11.4-4.3\"/><path d=\"m18.5 6 1.754 3.5a6.48 6.48 0 0 1-1.854 8.2C15.4 20.2 11 22 7 22a3 3 0 0 1-2.68-1.66L2.4 16.5\"/><circle cx=\"12.5\" cy=\"8.5\" r=\"2.5\"/>",
    ...
    "<path d=\"m14.5 7.5-5 5\"/><path d=\"M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H19a1 1 0 0 1 1 1v18a1 1 0 0 1-1 1H6.5a1 1 0 0 1 0-5H20\"/><path d=\"m9.5 7.5 5 5\"/>",
    ...
    "<path d=\"M10 9.728V16\"/><path d=\"M14 9.728V16\"/><path d=\"M18 20V4\"/><path d=\"m22 11-4-4A7.5 7.5 0 0 1 6 7l-4 4\"/><path d=\"M22 16H2\"/><path d=\"M6 20V4\"/>",
    ...
    "<path d=\"M21 10.5a9 2.5 0 01-18 0v8a9 2.5 0 0018 0z\"/><path d=\"M21 10.5A9 2.5 25.32 004.59 3.47 9 2.5 25.32 0021 10.5\"/><path d=\"M3 10.5a9 2.5 0 016.527-2.405\"/><path d=\"M9 16.858a31 31 0 006 0\"/>",
    "<path d=\"m17 22 1.664-2.496a2 2 0 00.336-1.11V5.606a2 2 0 00-.336-1.11L17 2\"/><path d=\"M18 22H6\"/><path d=\"M18 2H6\"/><path d=\"M5 17h14\"/><path d=\"M5 7h14\"/><path d=\"m7 22-1.664-2.496A2 2 0 015 18.394V5.606a2 2 0 01.336-1.11L7 2\"/>",
    ...
    "<rect width=\"8\" height=\"4\" x=\"8\" y=\"2\" rx=\"1\" ry=\"1\"/><path d=\"M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2\"/><path d=\"m14.5 11.5-5 5\"/><path d=\"m9.5 11.5 5 5\"/>",
    ...
    "<path d=\"M21.95 13a10 10 0 1 0-8.685 8.92\"/><path d=\"M12 6v6l4 2\"/><path d=\"m16 19 2 2 4-4\"/>",
    ...
    "<path d=\"M4 16a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2\"/><rect x=\"8\" y=\"8\" width=\"14\" height=\"14\" rx=\"2\"/><path d=\"m12.5 12.5 5 5\"/><path d=\"m12.5 17.5 5-5\"/>",
    ...
    "<path d=\"M12.5 19H4a2 2 0 01-2-2V7a2 2 0 012-2h16a2 2 0 012 2v4\"/><path d=\"m16 17 2 2 4-4\"/><path d=\"M2 10h20\"/>",
    "<path d=\"M16 17h6\"/><path d=\"M22 10H2\"/><path d=\"M22 13V7a2 2 0 00-2-2H4a2 2 0 00-2 2v10a2 2 0 002 2h8.536\"/>",
    "<path d=\"M16 17h6\"/><path d=\"M19 14v6\"/><path d=\"M22 10H2\"/><path d=\"M22 11.354V7a2 2 0 00-2-2H4a2 2 0 00-2 2v10a2 2 0 002 2h8.536\"/>",
    "<path d=\"M15 16v1\"/><path d=\"M16.963 7.734A1 1 0 0015.999 7H8.003a1 1 0 00-.964.734L4.073 18.467A2 2 0 006 21h12a2 2 0 001.927-2.532z\"/><path d=\"M2.678 8.5A2 2 0 012 7V5a2 2 0 012-2h16a2 2 0 012 2v2a2 2 0 01-.676 1.499\"/><path d=\"m9 21 2-14\"/>",
    "<path d=\"M12.5 19H4a2 2 0 01-2-2V7a2 2 0 012-2h16a2 2 0 012 2v3.5\"/><path d=\"m16.5 14.5 5 5\"/><path d=\"M2 10h20\"/><path d=\"m21.5 14.5-5 5\"/>",
    ...
    "<path d=\"M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16\"/><path d=\"M2 21h20\"/><path d=\"M9 12h.01\"/>",
    "<path d=\"M19 8V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16\"/><path d=\"M2 21h8\"/><path d=\"M20 16v-2a2 2 0 00-4 0v2\"/><path d=\"M9 12h.01\"/><rect x=\"14\" y=\"16\" width=\"8\" height=\"5\" rx=\"1\"/>",
    ...
    "<path d=\"M12 17v-3a1 1 0 011-1h6\"/><path d=\"M19 17h-9a1 1 0 00-1 1v3\"/><path d=\"M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16\"/><path d=\"M19 9h-3a1 1 0 00-1 1v3\"/><path d=\"M22 21H2\"/>",
    ...
    "<path d=\"M10 3h6\"/><path d=\"M13 3v4\"/><path d=\"M2 10v6\"/><path d=\"M2 13h4\"/><path d=\"M6 16a2 2 0 002 2h1a2 2 0 011.6.8l.3.4a2 2 0 001.6.8h2.264a2 2 0 001.789-1.106l1.67-3.341a1 1 0 01.895-.553H21a1 1 0 001-1v-4a1 1 0 00-1-1h-3.5a1 1 0 01-.8-.4l-.9-1.2A1 1 0 0015 7h-4a1 1 0 00-.8.4l-.9 1.2a1 1 0 01-.8.4H7a1 1 0 00-1 1z\"/>",
    ...
    "<path d=\"M15 12v-1.584\"/><path d=\"M17 10a5 5 0 00-3 1\"/><path d=\"M7 10a5 5 0 013 1\"/><path d=\"M9 12v-1.584\"/><path d=\"M9 17a5 5 0 016.001 0\"/><circle cx=\"12\" cy=\"12\" r=\"10\"/>",
    ...
    "<path d=\"M12 6h4a2 2 0 0 1 2 2v7\"/><path d=\"M6 12v9\"/><path d=\"m8.5 3.5-5 5\"/><path d=\"m8.5 8.5-5-5\"/><circle cx=\"18\" cy=\"18\" r=\"3\"/>",
    ...
    "<path d=\"m15.5 3.5 5 5\"/><path d=\"m15.5 8.5 5-5\"/><path d=\"M18 11.62V15\"/><path d=\"M6 9v12\"/><circle cx=\"18\" cy=\"18\" r=\"3\"/><circle cx=\"6\" cy=\"6\" r=\"3\"/>",
    ...
    "<path d=\"M12 3v17a1 1 0 0 1-1 1H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v6a1 1 0 0 1-1 1H3\"/><path d=\"m16.5 16.5 5 5\"/><path d=\"m16.5 21.5 5-5\"/>",
    ...
    "<path d=\"M12 3V2\"/><path d=\"M16.066 16.865 7 22l2-11V6a3 3 0 016 0v5l2 11\"/><path d=\"m19.792 4.5.866-.5\"/><path d=\"m19.797 13.5.866.5\"/><path d=\"M21 9h1\"/><path d=\"M3 9H2\"/><path d=\"m4.203 13.5-.866.5\"/><path d=\"M4.208 4.5 3.342 4\"/><path d=\"M5.5 22h13\"/><path d=\"m7.932 16.875 7.377-4.178\"/><path d=\"M8 11h8\"/><path d=\"M8 7h8\"/>",
    ...
    "<path d=\"M15.506 17.646A2 2 0 0015 18.5l-.837 2.87a.5.5 0 00.62.62l2.87-.837a2 2 0 00.854-.506l3.013-3.009a1 1 0 00-3.004-3.004z\"/><path d=\"M22 10.346V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12a2 2 0 002 2h6.396\"/><path d=\"m22 7-8.991 5.727a2 2 0 01-2.009 0L2 7\"/>",
    ...
    "<path d=\"M22 12.532V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h8.792\"/><path d=\"m22 7-8.991 5.727a2 2 0 0 1-2.009 0L2 7\"/><path d=\"m16.5 16.5 5 5\"/><path d=\"m21.5 16.5-5 5\"/>",
    ...
    "<path d=\"M2.992 16.342a2 2 0 0 1 .094 1.167l-1.065 3.29a1 1 0 0 0 1.236 1.168l3.413-.998a2 2 0 0 1 1.099.092 10 10 0 1 0-4.777-4.719\"/><path d=\"m16 9-5.5 5.5L8 12\"/>",
    ...
    "<path d=\"M11.25 17.25h1.5L12 18z\"/><path d=\"m15 12 2 2\"/><path d=\"M17.902 6.599a8 8 0 0 0-.5-.5\"/><path d=\"M2 14.5C2 19.47 6.48 22 12 22s10-2.53 10-7.5a10 10 0 0 0-1.3-4.83 4.5 4.5 0 1 0-7.05-5.5 8 8 0 0 0-3.3 0 4.5 4.5 0 1 0-7.04 5.5A10 10 0 0 0 2 14.5\"/><path d=\"M6.099 6.599a8 8 0 0 1 .5-.5\"/><path d=\"m9 12-2 2\"/>",
    ...
    "<path d=\"M10 13v4\"/><path d=\"M14 13v4\"/><path d=\"M18 13v4\"/><path d=\"M2 13h20\"/><path d=\"M22 11.5A3.5 3.5 0 0018.5 8a3.52 3.52 0 01-3.173-2A7 7 0 002 9v10a2 2 0 002 2h16a2 2 0 002-2z\"/><path d=\"M6 13v4\"/>",
    ...
    "<path d=\"M14.832 8.445a1 1 0 00-1.589-.098l-2.075 3.098a1 1 0 000 1.11l2 3a1 1 0 001.664 0l2-3a1 1 0 000-1.11z\"/><path d=\"m7.18 20.827-5-11a2 2 0 01.993-2.647L7 5.44\"/><rect x=\"7\" y=\"2\" width=\"14\" height=\"20\" rx=\"2\"/>",
    "<path d=\"M12.65 7.65a2 2 0 012.629-1.046l5.51 2.374a2 2 0 011.046 2.628l-3.957 9.184a2 2 0 01-2.628 1.046l-5.51-2.374a2 2 0 01-1.046-2.628z\"/><path d=\"M18 7.777V4a2 2 0 00-2-2h-6a2 2 0 00-2 2v10a2 2 0 001.137 1.805\"/><path d=\"m8 4.389-4.364.809a2 2 0 00-1.602 2.33l1.822 9.833a2 2 0 002.331 1.602l2.542-.47\"/>",
    ...
    "<path d=\"M12 21 7.5 8.322\"/><path d=\"m14 7 1.75-3.767a.5.5 0 0 1 .662-.172L20 5.005\"/><path d=\"m20 8.998-3.588 1.944a.5.5 0 0 1-.662-.172L14 7H8\"/><path d=\"M3.486 21h10\"/><path d=\"M5 21V8.732\"/><circle cx=\"6\" cy=\"7\" r=\"2\"/>",
    "<path d=\"M11 17h2\"/><path d=\"M12 12h.01\"/><path d=\"M17 12a5 5 0 00-10 0\"/><path d=\"M19 2v2.8\"/><path d=\"M2 5h2.8\"/><path d=\"M22 5h-2.8\"/><path d=\"M5 2v2.8\"/><circle cx=\"12\" cy=\"12\" r=\"10\"/>",
    ...
    "<path d=\"M12 15v-3\"/><path d=\"M12 2v2\"/><path d=\"M16.5 12V9a1 1 0 011-1h1a1 1 0 001-1V5a1 1 0 00-1-1h-13a1 1 0 00-1 1v2a1 1 0 001 1h1a1 1 0 011 1v3\"/><path d=\"M19.38 19c1.076-1.815 1.636-4.89 1.628-6.008a1 1 0 00-1-.992H3.984a1 1 0 00-1 .984c-.03 1.86.97 5.621 2.826 7.776\"/><path d=\"M2 20c.6.5 1.2 1 2.5 1 2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1s1.2 1 2.5 1c2.5 0 2.5-2 5-2 1.3 0 1.9.5 2.5 1\"/>",
    ...
    "<path d=\"M16 5h6\"/><path d=\"m2.05 2.05 1.099-.028a1 1 0 011.008.815l2.69 14.347A1 1 0 007.83 18H18\"/><path d=\"M4.564 5H12\"/><path d=\"M6.25 14h12.712a2 2 0 001.991-1.57l.514-3.113\"/><circle cx=\"18\" cy=\"20\" r=\"2\"/><circle cx=\"8\" cy=\"20\" r=\"2\"/>",
    "<path d=\"M16 5h6\"/><path d=\"M19 2v6\"/><path d=\"m2.05 2.05 1.099-.028a1 1 0 011.008.815l2.69 14.347A1 1 0 007.83 18H18\"/><path d=\"M4.564 5H12\"/><path d=\"M6.25 14h12.712a2 2 0 001.991-1.57l.172-1.041\"/><circle cx=\"18\" cy=\"20\" r=\"2\"/><circle cx=\"8\" cy=\"20\" r=\"2\"/>",
    ...
    "<path d=\"M10 2a3.28 3.28 0 003.227 1.798l6.17-.561A1 1 0 1119.614 8H8.5a6.44 6.44 0 00-5.63 9.75A6.5 6.5 0 008.5 21c1.38 0 2-.5 2.5-1\"/><path d=\"M10 8a8.5 8.5 0 000 8\"/><path d=\"M11 22c-.5-.5-1.12-1-2.5-1a1 1 0 010-5H12a7 7 0 007-7V8\"/><path d=\"M13 12h.01\"/><path d=\"M8 16c-2 0-4.5-4-4-6\"/>",
    "<path d=\"M10 2a3.28 3.28 0 003.227 1.798l6.17-.561A1 1 0 1119.614 8H13.5\"/><path d=\"M11 20c-.5.5-1.12 1-2.5 1a1 1 0 010-5H12a7 7 0 003.283-.817\"/><path d=\"M11 22c-.5-.5-1.12-1-2.5-1a6.5 6.5 0 01-5.63-3.25 6.44 6.44 0 015.236-9.744\"/><path d=\"M18.04 12.54A7 7 0 0019 9V8\"/><path d=\"m2 2 20 20\"/><path d=\"M8 16c-2 0-4.5-4-4-6\"/><path d=\"M9.43 9.33A8.5 8.5 0 0010 16\"/>",
    ...
    "<path d=\"m20 15-5.5 5.5L12 18\"/><path d=\"m4 16 6-12 5.115 10.23\"/><path d=\"M6 12h8\"/>",
    ...
    "<rect width=\"18\" height=\"18\" x=\"3\" y=\"3\" rx=\"2\"/><line x1=\"12\" x2=\"12\" y1=\"8\" y2=\"12\"/><line x1=\"12\" x2=\"12.01\" y1=\"16\" y2=\"16\"/>",
    ...
    "<path d=\"M12 2v20\"/><path d=\"M16 3h3a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-3\"/><path d=\"M8 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3\"/>",
    "<path d=\"M2 12h20\"/><path d=\"M21 16v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3\"/><path d=\"M3 8V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v3\"/>",
    ...
    "<path d=\"m11 19-6-6\"/><path d=\"m5 21-2-2\"/><path d=\"m8 16-4 4\"/><path d=\"M9.5 17.5 20.414 6.586A2 2 0 0021 5.172V3h-2.172a2 2 0 00-1.414.586L6.5 14.5\"/>",
    ...
    "<path d=\"M10 11.341V10\"/><path d=\"M14 13v-3\"/><path d=\"M18 17V8a2 2 0 00-2-2H4a2 2 0 00-2 2v7a2 2 0 002 2h2\"/><path d=\"M22 15v1a1 1 0 01-1 1H10\"/><path d=\"M6 11.341V10\"/><circle cx=\"8\" cy=\"17\" r=\"2\"/>",
    ...
    "<path d=\"m16.5 16.5 5 5\"/><path d=\"M2 21a8 8 0 0 1 11.531-7.18\"/><path d=\"m21.5 16.5-5 5\"/><circle cx=\"10\" cy=\"8\" r=\"5\"/>",
    ...
    "<path d=\"m12.828 4.813 5.344 2.375\"/><path d=\"m15.769 18.153 3.461-8.306\"/><path d=\"m5.687 14.074 7.625 4.852\"/><path d=\"M9.772 5.579 5.228 11.42\"/><circle cx=\"11\" cy=\"4\" r=\"2\"/><circle cx=\"15\" cy=\"20\" r=\"2\"/><circle cx=\"20\" cy=\"8\" r=\"2\"/><circle cx=\"4\" cy=\"13\" r=\"2\"/>",
    "<path d=\"M17.055 4.533a24 24 0 00-10.11 0\"/><path d=\"M19.467 17.055a24 24 0 000-10.11\"/><path d=\"M4.533 6.945a24 24 0 000 10.11\"/><path d=\"M6.945 19.467a24 24 0 0010.11 0\"/><circle cx=\"19\" cy=\"19\" r=\"2\"/><circle cx=\"19\" cy=\"5\" r=\"2\"/><circle cx=\"5\" cy=\"19\" r=\"2\"/><circle cx=\"5\" cy=\"5\" r=\"2\"/>",
    ...
    "<path d=\"M10 6v4\"/><path d=\"M21 6a1 1 0 0 1 1 1v2a1 1 0 0 1-1 1h-5.675A7 7 0 1 1 9 6z\"/>",
